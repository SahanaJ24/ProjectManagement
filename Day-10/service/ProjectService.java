...
public class ProjectService {
  ...
  public Project updateProjectById(int pId, Project project) {
	  Project pro = projectRepo.findById(pId).get();
	  pro.setPName(project.getPName());
	  pro.setPDescription(project.getPDescription());
	  pro.setPBudget(project.getPBudget());
	  pro.setPStdate(project.getPStdate());
	  pro.setPEndate(project.getPEndate());
	  
    return projectRepo.save(pro);
  }
  
  public String deleteByProjectId(int pId) {
