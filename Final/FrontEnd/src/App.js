...
import RiskGet from './Components/EmpRisk';
import EmpGet from './Components/EmpEmployee';
import AProfile from './Components/Aprofile';
import Project from './Components/AProject';
import ProGet from './Components/ProjectGet';
...
function App() {
  return (
      <Routes>
        ...
        <Route path='/EmpRisk' element={<RiskGet/>}/>
        <Route path='/EmpEmployee' element={<EmpGet/>}/>
        <Route path='/Aprofile' element={<AProfile/>}/>
        <Route path='/Aproject' element={<Project/>}/>
        <Route path='/ProjectGet' element={<ProGet/>}/>
