...
export const Login = (props) =>{
    ...
    const handleSubmit = (e) =>{
		e.preventDefault(); //Store the values in console even if the page is refreshed
	...
	return(
		<div className="container">
			...
			<form className="flogin" onSubmit={handleSubmit}>
				<label> UserId </label>
				<input value={id} onChange={(e) => setId(e.target.value)} name="id" id="id" type="text" placeholder="UserId"/>
